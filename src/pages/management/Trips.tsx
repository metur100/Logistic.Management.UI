    ...
    <div style={{ width: '100%', maxWidth: '100%', overflowX: 'hidden', boxSizing: 'border-box' }}>
      <style>{`
        ...
        @media (max-width: 500px) {
          ...
          .trips-toolbar input,
          .trips-toolbar select { width: 100%; flex: unset; }
        }
      `}</style>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ opacity: .8, fontSize: '.82rem', margin: 0 }}>
            {trips.length} {t('trips').toLowerCase()}
          </p>
        </div>
        <button
                      ...
                      <tr
                        ...
                        <td>
                          <span style={{
                            ...
                            {STATUS_ICONS[tr.status]} {t(`status_${tr.status}`)}
                          </span>
                        </td>
                ...
                <div
                  ...
                  <div style={{
                    ...
                    <div style={{ minWidth: 0, flex: 1 }}>
                      <div style={{
                        fontWeight: 800, fontSize: '.95rem', marginBottom: '.2rem',
